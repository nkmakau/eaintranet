<?php 
	...
	//Get data for April
	$result_April = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m1'");
	$row_April = mysqli_fetch_array($result_April);
	
	//Get data for May
	$result_May = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m2'");
	$row_May = mysqli_fetch_array($result_May);
	
	//Get data for Jun
	$result_Jun = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m3'");
	$row_Jun = mysqli_fetch_array($result_Jun);
	
	//Get data for Jul
	$result_Jul = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m4'");
	$row_Jul = mysqli_fetch_array($result_Jul);
	
	//Get data for Aug
	$result_Aug = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m5'");
	$row_Aug = mysqli_fetch_array($result_Aug);
	
	//Get data for Sep
	$result_Sep = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m6'");
	$row_Sep = mysqli_fetch_array($result_Sep);
	
	//Get data for Oct
	$result_Oct = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m7'");
	$row_Oct = mysqli_fetch_array($result_Oct);
	
	//Get data for Nov
	$result_Nov = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m8'");
	$row_Nov = mysqli_fetch_array($result_Nov);
	$TotalANov = "";	
	if($username=="dkinyanjui"){
		$TotalNov = mysqli_num_rows($result_Nov);
		$TotalANov = " (".$TotalNov.")";
	}
	
	
	//Get data for Dec
	$result_Dec = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m9'");
	$row_Dec = mysqli_fetch_array($result_Dec);
	
	//Get data for Jan
	$result_Jan = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m10'");
	$row_Jan = mysqli_fetch_array($result_Jan);
	
	//Get data for Feb
	$result_Feb = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m11'");
	$row_Feb = mysqli_fetch_array($result_Feb);
	
	//Get data for Mar
	$result_Mar = mysqli_query($link,"SELECT * FROM EBU_ScoreCard WHERE Username='" . $username . "' and Month='$m12'");
	$row_Mar = mysqli_fetch_array($result_Mar);
	
	/* FIRST Half */
	
	//Get Average for Adherence first half
	$result_A_Adh = mysqli_query($link,"SELECT AVG(Adherence) AS AA FROM EBU_ScoreCard WHERE Username='" . $username . "' and Adherence REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6')");
	$row_A_Adh = mysqli_fetch_array($result_A_Adh);
	
	//Get Average for Email Quality first half
	$result_A_Email = mysqli_query($link,"SELECT AVG(EmailQuality) AS AE FROM EBU_ScoreCard WHERE Username='" . $username . "' and EmailQuality REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6')");
	$row_A_Email = mysqli_fetch_array($result_A_Email);
	
	//Get Average for SR first half
	$result_A_SR = mysqli_query($link,"SELECT AVG(SRQuality) AS ASR FROM EBU_ScoreCard WHERE Username='" . $username . "' and SRQuality REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6')");
	$row_A_SR = mysqli_fetch_array($result_A_SR);
	
	//Get Average for Revenue first half
	$result_A_Rev = mysqli_query($link,"SELECT AVG(Revenue) AS ARev FROM EBU_ScoreCard WHERE Username='" . $username . "' and Revenue REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6')");
	$row_A_Rev = mysqli_fetch_array($result_A_Rev);
	
	//Get Average for NPS first half
	$result_A_NPS = mysqli_query($link,"SELECT AVG(NPS) AS ANPS FROM EBU_ScoreCard WHERE Username='" . $username . "' and NPS REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6')");
	$row_A_NPS = mysqli_fetch_array($result_A_NPS);
	
	//Get Average for interactions first half
	$result_A_Int = mysqli_query($link,"SELECT AVG(interactions) AS AInt FROM EBU_ScoreCard WHERE Username='" . $username . "' and interactions REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6')");
	$row_A_Int = mysqli_fetch_array($result_A_Int);
	
	/* SECOND Half */
	
	//Get Average for Adherence
	$result2_A_Adh = mysqli_query($link,"SELECT AVG(Adherence) AS ASA FROM EBU_ScoreCard WHERE Username='" . $username . "' and Adherence REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6' OR Month='$m7' OR Month='$m8' OR Month='$m9' OR Month='$m10' OR Month='$m11' OR Month='$m12')");
	$row2_A_Adh = mysqli_fetch_array($result2_A_Adh);
	
	//Get Average for Email Quality
	$result2_A_Email = mysqli_query($link,"SELECT AVG(EmailQuality) AS ASE FROM EBU_ScoreCard WHERE Username='" . $username . "' and EmailQuality REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6' OR Month='$m7' OR Month='$m8' OR Month='$m9' OR Month='$m10' OR Month='$m11' OR Month='$m12')");
	$row2_A_Email = mysqli_fetch_array($result2_A_Email);
	
	//Get Average for SR
	$result2_A_SR = mysqli_query($link,"SELECT AVG(SRQuality) AS ASSR FROM EBU_ScoreCard WHERE Username='" . $username . "' and SRQuality REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6' OR Month='$m7' OR Month='$m8' OR Month='$m9' OR Month='$m10' OR Month='$m11' OR Month='$m12')");
	$row2_A_SR = mysqli_fetch_array($result2_A_SR);
	
	//Get Average for Revenue
	$result2_A_Rev = mysqli_query($link,"SELECT AVG(Revenue) AS ASRev FROM EBU_ScoreCard WHERE Username='" . $username . "' and Revenue REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6' OR Month='$m7' OR Month='$m8' OR Month='$m9' OR Month='$m10' OR Month='$m11' OR Month='$m12')");
	$row2_A_Rev = mysqli_fetch_array($result2_A_Rev);
	
	//Get Average for NPS
	$result2_A_NPS = mysqli_query($link,"SELECT AVG(NPS) AS ASNPS FROM EBU_ScoreCard WHERE Username='" . $username . "' and NPS REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6' OR Month='$m7' OR Month='$m8' OR Month='$m9' OR Month='$m10' OR Month='$m11' OR Month='$m12')");
	$row2_A_NPS = mysqli_fetch_array($result2_A_NPS);
	
	//Get Average for interactions
	$result2_A_Int = mysqli_query($link,"SELECT AVG(interactions) AS ASInt FROM EBU_ScoreCard WHERE Username='" . $username . "' and interactions REGEXP '[0-9]' and (Month='$m1' OR Month='$m2' OR Month='$m3' OR Month='$m4' OR Month='$m5' OR Month='$m6' OR Month='$m7' OR Month='$m8' OR Month='$m9' OR Month='$m10' OR Month='$m11' OR Month='$m12')");
...
<div class="w3-main w3-card" style="margin:10px 0;border:1px solid #ccc;">
	...
	<div class="w3-container w3-green">
		<h2 class="w3-left">Agent Scorecard View</h2>
			...
			<div class="w3-responsive w3-padding-16">
				<table class="w3-table-all  w3-centered">
					...
					<tr>
						  ...
						  <td class="w3-pale-green w3-left-align"><b>Score</b></td>
						  <td><?php  if($row_April['Interactions']){$row_April['Interactions']; } elseif($row_April['Interactions'] == "Not Apply") { echo "Not Apply";} ?></td>
						  <td><?php  if($row_May['Interactions']){$row_May['Interactions']; } elseif($row_May['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Jun['Interactions']){$row_Jun['Interactions']; } elseif($row_Jun['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Jul['Interactions']){$row_Jul['Interactions']; } elseif($row_Jul['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Aug['Interactions']){$row_Aug['Interactions']; } elseif($row_Aug['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Sep['Interactions']){$row_Sep['Interactions']; } elseif($row_Sep['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td class="w3-pale-green">
						  	<?php 
						  		if($row_A_Int['AInt'] <> 0) {
						  			echo $row_A_Int['AInt'];
			...
			<div class="w3-responsive w3-padding-16">
				<table class="w3-table-all  w3-centered">
					...
					<tr>
						  <td class="w3-pale-green w3-left-align"><b>Interactions</b></td>
						  <td class="w3-pale-green w3-left-align"><b>Score</b></td>
						  <td><?php  if($row_Oct['Interactions']){$row_Oct['Interactions']; } elseif($row_Oct['Interactions'] == "Not Apply") { echo "Not Apply";} ?></td>
						  <td><?php  if($row_Nov['Interactions']){$row_Nov['Interactions']; } elseif($row_Nov['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Dec['Interactions']){$row_Dec['Interactions']; } elseif($row_Dec['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Jan['Interactions']){$row_Jan['Interactions']; } elseif($row_Jan['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Feb['Interactions']){$row_Feb['Interactions']; } elseif($row_Feb['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td><?php  if($row_Mar['Interactions']){$row_Mar['Interactions']; } elseif($row_Mar['Interactions'] == "Not Apply") { echo "Not Apply";}  ?></td>
						  <td class="w3-pale-green">
						  	<?php 
