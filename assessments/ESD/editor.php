                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select type="text" class="form-control" id="EmployeeName" name="EmployeeName"
                                    onChange="EsdScores()" required>
                                    <option value="">Select Analyst</option>
                                    <option value="Antoninah Njoroge">Antoninah Njoroge</option>
                                    <option value="Benadette Jepkorir Kiplagat">Benadette Jepkorir Kiplagat</option>
                                    <option value="Benard N Wachira">Benard N Wachira</option>
                                    <option value="Brian Buziba">Brian Buziba</option>
                                    <option value="Charles kinuthia kagia">Charles Kinuthia Kagia</option>
                                    <option value="Collins Chesang">Collins Chesang</option>
                                    <option value="Daniel karanja Waigwa">Daniel Karanja Waigwa</option>
                                    <option value="David Mutende">David Mutende</option>
                                    <option value="Diana Kemunto Akara">Diana Kemunto Akara</option>
                                    <option value="Elizabeth Muthoni Mutuma">Elizabeth Muthoni Mutuma</option>
                                    <option value="Geoffrey Kiplangat Korir">Geoffrey Kiplangat korir</option>
                                    <option value="Gichana Bosire">Gichana Bosire</option>
                                    <option value="Gloria Adhiambo">Gloria Adhiambo</option>
                                    <option value="Jecinta Okello Awino">Jecinta Okello Awino</option>
                                    <option value="Jones Nyauma Nyakoe">Jones Nyauma Nyauma</option>
                                    <option value="Leban Chumba">Leban Chumba</option>
                                    <option value="Melisa N. Mutangili">Melisa N. Mutangili</option>
                                    <option value="Oliver Ndiwa">Oliver Ndiwa</option>
                                    <option value="Phylis Mureithi">Phylis Mureithi</option>
                                    <option value="Purity Kerubo Nyaigoti">Purity Kerubo Nyaigoti</option>
                                    <option value="Rayana Anyango Odhiambo">Rayana Anyango Odhiambo</option>
                                    <option value="Roseline Kogi">Roseline Kogi</option>
                                    <option value="Salome Wangui Murigu">Salome Wangui Murigu</option>
                                    <option value="Weldon Koech">Weldon koech</option>
                                    <option value="Winnie Akinyi Osii">Winnie Akinyi Osii</option>
                            ...
                            <div class="col-lg-4">
                                ...
                                <select type="text" class="form-control" id="month" name="month" onChange="EsdScores()"
                                    required>
                            ...
                            <div class="col-lg-4">
                                ...
                                <select type="text" class="form-control" id="year" name="year" onChange="EsdScores()"
                                    required>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#showEsdassessment">ESD Analyst
                                    Assessment</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div id="showEsdassessment" class="container tab-pane active"><br>
                                ...
                                function EsdScores() {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            $("#showEsdassessment").html(data);
                                        },
                                        error: function(data) {
                                            $("#showEsdassessment").html("Failed " + data);
                                        }
                                    });
                                }
                            </script>
