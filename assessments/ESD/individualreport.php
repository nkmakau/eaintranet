                ...
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select type="text" class="form-control" id="month" name="month"
                                    onChange="dealerScores()" required>
                            ...
                            <div class="col-lg-4">
                                ...
                                <select type="text" class="form-control" id="year" name="year" onChange="dealerScores()"
                                    required>
                                ...
                                <input type="hidden" class="form-control" id="Dealer" name="Dealer" value="Dealer"
                                    required />
                            </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#showmyceeassessment">Dealer
                                    Assessment - Individual Report</a>
                            </li>
                        </ul>

                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div id="showmydealerassessment" class="container tab-pane active"><br>
                                ...
                                function dealerScores() {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            $("#showmydealerassessment").html(data);
                                        },
                                        error: function(data) {
                                            $("#showmydealerassessment").html("Failed " + data);
                                        }
                                    });
                                }
                            </script>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <!-- About -->
                    <div class="">
                        <p style="color: #fff;">© SafaricomIntranet 2019 – All Right Reserved</p>
                    </div>
                </div>
