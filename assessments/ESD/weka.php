...
<?
 ...
 if ($monthSelected == "" || $yearSelected == "" || $SRDate == "" || $AssessmentDate == "" || $SRNo == "" || $EmployeeName == "" || $Assign == "" || $OrderCreation == "" || $SRClose == "" || $KYC == "" || $Quality == "" ) {
 ?>
 ...
 <script type="text/javascript" language="javascript">
     ...
     confirm(message)
     window.location.href="esdassessment.php";
 ...
 $sqlInsert = "insert into ".tbl_esdassessments."(monthSelected, yearSelected, SRDate, AssessmentDate, SRNo, EmployeeName, Segment, Assign, OrderCreation, SRCLose,  "._; 
