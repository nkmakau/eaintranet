...
mysql_select_db($database_DBConn, $DBConn);
$query_rsMonths = "SELECT MonthName FROM SC_ScorecardEvalMonth WHERE (`Flag` = 'Yb' AND TLFlag=1 AND Year='Y20') ORDER BY MonthID ASC";
...
<title>Teams Performance - Monthly April 2020 - September 2020...</title>
...
<table width="100%" border="1" cellpadding="1" cellspacing="1">
    <tr>
      ...
      <td align="center" bgcolor="#E9FFBB"><strong>Call <br />
        Quality</strong></td>      
      <td align="center" bgcolor="#E9FFBB"><strong>NPS</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Resolution</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Satisfaction</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>QoE</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Adherence</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Calls Ans<br /> Daily</strong></td>
      ...
      <tr>
        ...
        <td align="center"><?php echo $row_rscalls['Skillset']; ?></td>
		 ...
		 <td align="center"><?php if ( is_numeric($row_rscalls['CQ']) ) {
			...
			<?php echo $row_rscalls['CQPDR']?>		 
		</td>
        
		  <!--NPS-->
        <td align="center"><?php if ( is_numeric($row_rscalls['NPS']) ) {
						echo round($row_rscalls['NPS'])." ";
					} else {
					echo $row_rscalls['NPS'];
					}?><br>
			<?php echo $row_rscalls['NPSPDR']?>			
		</td>
		  
		<!--Resolution-->
        <td align="center"><?php if ( is_numeric($row_rscalls['Resolution']) ) {
						echo round($row_rscalls['Resolution']) . "%"." ";
					} else {
					echo $row_rscalls['Resolution'];
					}?><br>
			<?php echo $row_rscalls['ResolutionPDR']?>		
		</td>
		  
		<!--Satisfaction-->
        <td align="center"><?php if ( is_numeric($row_rscalls['Satisfaction']) ) {
						echo round($row_rscalls['Satisfaction'],2)." ";
					} else {
					echo $row_rscalls['Satisfaction'];
					}?><br>
          <?php echo $row_rscalls['SatisfactionPDR']?>
		 </td>	
		
        <!--QoE-->
        <td align="center"><?php if (is_numeric($row_rscalls['QoE'])) {
						echo round($row_rscalls['QoE'],2)*100 . "%"." ";
					} else {
					echo $row_rscalls['QoE'];
					}?><br>
          <?php echo $row_rscalls['QoEPDR']?>
		</td>
        ...
        <td align="center"><?php if (is_numeric($row_rscalls['Adhe']) ) {
          ...
          <?php echo $row_rscalls['AdhePDR']?>
		  </td>
		  
		<!--Calls answered-->
        <td align="center"><?php echo $row_rscalls['CallsAnsweredDaily']; ?><br><?php echo $row_rscalls['CallsAnsweredPDR']; ?></td>
		  
		<!--TalkTime-->
        <td align="center"><?php echo $row_rscalls['TalkTime']; ?><br><?php echo $row_rscalls['TTPDR']; ?></td>
        ...
        <td align="center"><?php  if (is_numeric($row_rscalls['ShortCalls']) ) {
          ...
          <?php echo $row_rscalls['ShortCallsPDR']?>
		  </td>
...
<?php if ($totalRows_rscalls == 0) { // Show if recordset empty ?>
  ...
  <table width="100%" border="1" cellpadding="1" cellspacing="1">
    <tr>
      <td align="center" bgcolor="#E9FFBB"><strong>Agentname</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Skillset</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>SMS <br />Quality</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>NPS</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Resolution</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Satisfaction</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>QoE</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>SMS Closed</strong></td>
      <td align="center" bgcolor="#E9FFBB"><strong>Adherance</strong></td>
	...
	<!--SMS Quality-->
        <td align="center"><?php if ( is_numeric($row_rsSMS['SMSCQ']) ) {
						echo round($row_rsSMS['SMSCQ'],4)*100 . "%"." ";
					} else {
					echo $row_rsSMS['SMSCQ'];
					}?>
			<br>
            <?php echo $row_rsSMS['SMSCQPDR']?>
          </td>
		...
		<!--Closed SMS-->
        <td align="center"><?php echo $row_rsSMS['ClosedSMS']; ?><br>
          <?php echo $row_rsSMS['ClosedSMSPDR']?></td>
		...
		<!--Login-->
        <td align="center"><?php echo $row_rsSMS['Login']; ?><br>
          <?php echo $row_rsSMS['LoginPDR']?>
		  </td>
		<!--Month-->
        <td align="center"><?php echo $row_rsSMS['MTHSMS']; ?></td>
      </tr>
...
<?php if ($totalRows_rsSMS == 0) { // Show if recordset empty ?>
 ...
 <div id="jQueryUITabs1-3">
  ...
  <table width="100%" border="1">
    <tr>
      <td width="7%" bgcolor="#E9FFBB"><strong>EKNO</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>Agentname</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>Skillset</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>Call Quality</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>NPS</strong></td>
      <td width="7%" bgcolor="#E9FFBB"><strong>Resolution</strong></td>
      <td width="7%" bgcolor="#E9FFBB"><strong>Satisfaction</strong></td>
      <td width="7%" bgcolor="#E9FFBB"><strong>eMail</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>Service <br />
        Request</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>SLA</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>Reversals</strong></td>
      <td width="9%" bgcolor="#E9FFBB"><strong>Month</strong></td>
      </tr>
    <?php do { ?>
      <tr>
        ...
        <td><?php if ( is_numeric($row_rscalls['NPS']) ) {
						echo round($row_rscalls['NPS']) ." ";
					} else {
					echo $row_rscalls['NPS'];
					}?>
          <br>
        <?php echo $row_rscalls['NPSPDR']?></td>
        <td><?php if ( is_numeric($row_rscalls['Resolution']) ) {
						echo round($row_rscalls['Resolution']) . "%"." ";
					} else {
					echo $row_rscalls['Resolution'];
					}?>
          <br />
        <?php echo $row_rscalls['ResolutionPDR']?></td>
        <td><?php if ( is_numeric($row_rscalls['Satisfaction']) ) {
						echo round($row_rscalls['Satisfaction'],2)." ";
					} else {
					echo $row_rscalls['Satisfaction'];
					}?>
          <br />
        <?php echo $row_rscalls['SatisfactionPDR']?></td>
...
// EndWebWidget jQuery_UI_Tabs: jQueryUITabs1
  ...
  <tr>
    <td width="6%" align="center" bgcolor="#E9FFBB"><strong>Call <br />
    Quality</strong></td>
    <td width="4%" align="center" bgcolor="#E9FFBB"><strong>NPS</strong></td>
    <td width="8%" align="center" bgcolor="#E9FFBB"><strong>Resolution</strong></td>
    <td width="7%" align="center" bgcolor="#E9FFBB"><strong>Satisfaction</strong></td>
    <td width="8%" align="center" bgcolor="#E9FFBB"><strong>Service <br />
    Request</strong></td>
    <td width="5%" align="center" bgcolor="#E9FFBB"><strong>eMail</strong></td>
    <td width="8%" align="center" bgcolor="#E9FFBB"><strong>Calls <br />
      Answered</strong></td>
    <td width="8%" align="center" bgcolor="#E9FFBB"><strong>Calls <br />
    Ans. Daily</strong></td>
    <td width="9%" align="center" bgcolor="#E9FFBB"><strong>Adherence</strong></td>
    <td width="8%" align="center" bgcolor="#E9FFBB"><strong>Reversals</strong></td>
    <td width="4%" align="center" bgcolor="#E9FFBB"><strong>Talk <br />
    Time</strong></td>
    <td width="6%" align="center" bgcolor="#E9FFBB"><strong>SMS <br />
    Quality</strong></td>
    <td width="6%" align="center" bgcolor="#E9FFBB"><strong>SMS <br />
    Closed</strong></td>
    <td width="7%" align="center" bgcolor="#E9FFBB"><strong>SMS SL</strong></td>
    <td width="6%" align="center" bgcolor="#E9FFBB"><strong>LogIn</strong></td>
  </tr>
  <tr>
    <td align="center"><?php $result = mysql_query("SELECT Sum(CQ) AS CQ, count(CQ) cnCQ FROM sc_calls_20_21a WHERE Skillset <> 'SMS' AND CQ REGEXP '[0-9]' AND TLCQ LIKE '%".$Value1."%' AND MTHCQ LIKE '%".$Value2."%'");
					...
					?>
<!--
    <p> Met:<?php $result = mysql_query("SELECT	100 * (SELECT COUNT(CQRating)FROM sc_calls_20_21a WHERE `TLCQ` LIKE '%".$Value1."%' AND `MTHCQ` LIKE '%".$Value2."%' AND `CQRating` LIKE 'Met') / COUNT(CQRating) AS Met
FROM sc_calls_20_21a WHERE `TLCQ` LIKE '%".$Value1."%' AND `MTHCQ` LIKE '%".$Value2."%'");
while($row = mysql_fetch_array($result))  													
  					 { echo ($result). "%";} 
					?></p>
-->
    ...
    <td align="center"><?php $result = mysql_query("SELECT Sum(NPS) AS NPS, count(NPS) cnNPS FROM sc_calls_20_21a WHERE NPS REGEXP '[0-9]' AND TLCQ LIKE '%".$Value1."%' AND MTHCQ LIKE '%".$Value2."%'");
					while($row = mysql_fetch_array($result))
  					{
  					$npst=$row['NPS'];
					$npsn=$row['cnNPS'];					
  					if ( $row['NPS'] <> 0 AND $row['cnNPS'] <> 0) {
						echo round(($npst/$npsn));
						} else {
					echo "";
					}  
					}
					?></td>
    <td align="center"><?php $result = mysql_query("SELECT Sum(Resolution) AS Res, count(Resolution) cnRes FROM sc_calls_20_21a WHERE Resolution REGEXP '[0-9]' AND TLCQ LIKE '%".$Value1."%' AND MTHCQ LIKE '%".$Value2."%'");
					while($row = mysql_fetch_array($result))
  					{
  					$rest=$row['Res'];
					$resn=$row['cnRes'];					
  					if ( $row['Res'] <> 0 AND $row['cnRes'] <> 0) {
						echo round(($rest/$resn)). "%";
						} else {
					echo "";
					}  
					}
					?></td>
    <td align="center"><?php $result = mysql_query("SELECT Sum(Satisfaction) AS SAT, count(Satisfaction) cnSAT FROM sc_calls_20_21a WHERE Satisfaction REGEXP '[0-9]' AND TLCQ LIKE '%".$Value1."%' AND MTHCQ LIKE '%".$Value2."%'");
					while($row = mysql_fetch_array($result))
  					{
  					$satt=$row['SAT'];
					$satn=$row['cnSAT'];					
  					if ( $row['SAT'] <> 0 AND $row['cnSAT'] <> 0) {
						echo round(($satt/$satn),2);
						} else {
					echo "";
					}  
					}
